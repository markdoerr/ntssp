...
namespace DisplayEngine.Display2D
{
    ...
    public class BasicPrimitives
    {
        ...
        public void CreateCircle(float _fRadius, int _nSides)
        {
            ...
            {
                m_VectorList.Add(new Vector2(_fRadius * (float)System.Math.Cos((double)fTheta),
                                             _fRadius * (float)System.Math.Sin((double)fTheta)));
            }
            //
            //////////////////////////////////////////////////////////////////////////
        }
        ...
        public void CreateEllipse(float _fSemiMajorAxis, float _fSemiMinorAxis, int _nSides)
        {
            ...
            for (float fTheta = fMax; fTheta >= -1; fTheta -= fStep)
            {
                m_VectorList.Add(new Vector2((float)(_fSemiMajorAxis * System.Math.Cos(fTheta)),
                                             (float)(_fSemiMinorAxis * System.Math.Sin(fTheta))));
            }
            //
            //////////////////////////////////////////////////////////////////////////
        }
        ...
        public void RenderPointPrimitive(SpriteBatch _spriteBatch)
        {
            ...
            for (int i = m_VectorList.Count - 1; i >= 1; --i)
            {
                ...
                fAngle = (float)System.Math.Atan2((double)(vPosition2.Y - vPosition1.Y),
        ...
        public void RenderSquarePrimitive(SpriteBatch _spriteBatch)
        {
            ...
            for (int i = m_VectorList.Count - 1; i >= 1; --i)
            {
                ...
                nCount = (int)System.Math.Round(fDistance);
                //
                //////////////////////////////////////////////////////////////////////////
